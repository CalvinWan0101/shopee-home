...
public class ProductDaoImplementationSpec {
    ...
    public void get_by_id_iphone() {
        feature.newScenario("Get iPhone by ID").withRule("Get Product by ID").Given("an iPhone product ID", env -> {
    ...
    public void get_by_id_xiaomi() {
        feature.newScenario("Get Xiaomi by ID").withRule("Get Product by ID").Given("a Xiaomi product ID", env -> {
    ...
    public void get_by_id_tissue() {
        feature.newScenario("Get Tissue by ID").withRule("Get Product by ID").Given("a Tissue product ID", env -> {
    ...
    public void get_by_id_toothbrush() {
        feature.newScenario("Get Toothbrush by ID").withRule("Get Product by ID").Given("a Toothbrush product ID", env -> {
    ...
    public void get_by_name() {
        feature.newScenario("Get Products by Name").withRule("Get Product by Name").Given("a partial product name", env -> {
            env.put("name", "i");
    ...
    public void get_id_by_name_deleted() {
        feature.newScenario("Get Deleted Product by Name").withRule("Get Product by Name").Given("a deleted product name", env -> {
    ...
    public void get_id_by_name_not_found() {
        feature.newScenario("Get Non-existent Product by Name").withRule("Get Product by Name").Given("a non-existent product name", env -> {
    ...
    public void get_all_name_by_id() {
        feature.newScenario("Get All Product Names by ID").withRule("Get All Product Names").When("I retrieve all product names", env -> {
    ...
    public void get_all_name_by_shop_id() {
        feature.newScenario("Get All Product Names by Shop ID").withRule("Get All Product Names").Given("a shop ID", env -> {
    ...
    public void update_sales_by_id() {
        feature.newScenario("Update Product Sales by ID").withRule("Update Product Sales by ID").Given("an existing product ID and new sales amount", env -> {
            env.put("id", "6874ada1-747f-41a7-bb9a-613d2ec0ce1d");
            env.put("sales", 29);
