...
public class ShopControllerSpec {
    ...
    public void register() {
        feature.newScenario("Register shop").withRule("Register Shop").Given("a new shop", env -> {
    ...
    public void get_by_id() {
        feature.newScenario("Get shop by ID").withRule("Get Shop by ID").Given("an existing shop ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void update_by_id() {
        feature.newScenario("Update shop by ID").withRule("Update Shop by ID").Given("an existing shop ID and new shop details", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void delete_by_id() {
        feature.newScenario("Delete shop by ID").withRule("Delete Shop by ID").Given("an existing shop ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void login_success() {
        feature.newScenario("Login success").withRule("Shop Login").Given("a shop's correct email and password", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
                    .post("/shop/login")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content("""
    ...
    public void login_with_not_exist_email() {
        feature.newScenario("Login with non-existent email").withRule("Shop Login").Given("a shop's non-existent email", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
                    .post("/shop/login")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content("""
    ...
    public void login_with_wrong_password() {
        feature.newScenario("Login with wrong password").withRule("Shop Login").Given("a shop's correct email and wrong password", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
                    .post("/shop/login")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content("""
