...
public class UserControllerSpec {
    ...
    public void register() {
        feature.newScenario("Register user").withRule("Register User").Given("a new user", env -> {
    ...
    public void get_by_id() {
        feature.newScenario("Get user by ID").withRule("Get User by ID").Given("an existing user ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void update_by_id() {
        feature.newScenario("Update user by ID").withRule("Update User by ID").Given("an existing user ID and new user details", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void delete_by_id() {
        feature.newScenario("Delete user by ID").withRule("Delete User by ID").Given("an existing user ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void login_success() {
        feature.newScenario("Login success").withRule("User Login").Given("a user's correct email and password", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
                    .post("/user/login")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content("""
    ...
    public void login_with_not_exist_email() {
        feature.newScenario("Login with non-existent email").withRule("User Login").Given("a user's non-existent email", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
                    .post("/user/login")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content("""
    ...
    public void login_with_wrong_password() {
        feature.newScenario("Login with wrong password").withRule("User Login").Given("a user's correct email and wrong password", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
                    .post("/user/login")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content("""
