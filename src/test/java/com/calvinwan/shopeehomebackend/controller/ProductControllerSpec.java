...
public class ProductControllerSpec {
    ...
    @Transactional
    public void insert() {
        feature.newScenario("Insert product").withRule("Insert Product").Given("a new product", env -> {
    ...
    public void get_by_id() {
        feature.newScenario("Get product by ID").withRule("Get Product by ID").Given("an existing product ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void get_by_id_not_found() {
        feature.newScenario("Get product by non-existent ID").withRule("Get Product by ID").Given("a non-existent product ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void get_id_by_name() {
        feature.newScenario("Get product ID by name").withRule("Get Product by Name").Given("an existing product name", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void get_id_by_name_with_uncompleted_name() {
        feature.newScenario("Get product ID by incomplete name").withRule("Get Product by Name").Given("an incomplete product name", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
                    .get("/product/id/i"));
        }).When("I send a get request", env -> {
            RequestBuilder requestBuilder = env.get("requestBuilder", RequestBuilder.class);
    ...
    public void get_id_by_name_not_found() {
        feature.newScenario("Get product ID by non-existent name").withRule("Get Product by Name").Given("a non-existent product name", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void get_all_name() {
        feature.newScenario("Get all product names").withRule("Get Product by Name").Given("a request to get all product names", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void get_all_name_by_shop_id() {
        feature.newScenario("Get all product names by shop ID").withRule("Get Product by Name").Given("a shop ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void get_product_preview_by_id() {
        feature.newScenario("Get product preview by ID").withRule("Get Product by ID").Given("a product ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void get_product_preview_by_id_not_found() {
        feature.newScenario("Get product preview by non-existent ID").withRule("Get Product by ID").Given("a non-existent product ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void update_product_by_id() {
        feature.newScenario("Update product by ID").withRule("Update Product by ID").Given("an existing product ID and new product details", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void update_product_by_id_not_found() {
        feature.newScenario("Update product by non-existent ID").withRule("Update Product by ID").Given("a non-existent product ID and new product details", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void update_product_sales_by_id() {
        feature.newScenario("Update product sales by ID").withRule("Update Product Sales by ID").Given("an existing product ID and sales update", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void update_product_sales_by_id_not_found() {
        feature.newScenario("Update product sales by non-existent ID").withRule("Update Product Sales by ID").Given("a non-existent product ID and sales update", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
    ...
    public void delete_product_by_id() {
        feature.newScenario("Delete product by ID").withRule("Delete Product by ID").Given("an existing product ID", env -> {
            env.put("requestBuilder", MockMvcRequestBuilders
